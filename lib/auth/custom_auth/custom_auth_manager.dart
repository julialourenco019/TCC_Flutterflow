...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    lionsOficialAuthUserSubject.add(
      LionsOficialAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<LionsOficialAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  LionsOficialAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LionsOficialAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    lionsOficialAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
LionsOficialAuthUser? currentUser;
